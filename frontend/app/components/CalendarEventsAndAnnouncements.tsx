    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl border border-blue-100 shadow-lg overflow-hidden">
        <div className="p-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
          ...
          <p className="text-blue-100 text-sm">Select a date to manage events</p>
        </div>
        ...
        <div className="p-4 bg-white">
          ...
          <div className="mt-4 flex justify-center gap-6 text-sm">
            {[
              { color: "bg-blue-600", label: "Selected", textColor: "text-blue-600" },
              { color: "bg-red-100 border-2 border-red-300", label: "Today", textColor: "text-red-600" },
              { color: "bg-blue-100 border-2 border-blue-400", label: "Has Events", textColor: "text-blue-600" }
            ].map((item, index) => (
            ...
            <div className="space-y-6">
              ...
              {filteredEvents.length === 0 ? (
                <div className="text-center py-8 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
                  ...
                  <p className="text-blue-500 text-sm mt-1">Create your first event below</p>
                </div>
              ) : (
              ...
              {/* Add Event Form */}
              <form onSubmit={handleEventSubmit} className="space-y-4 bg-gradient-to-br from-blue-50 to-white p-6 rounded-xl border border-blue-200">
                <h4 className="font-semibold text-blue-800 text-lg mb-4">➕ Add New Event</h4>
                <div>
                  <label htmlFor="eventTitle" className="block text-sm font-medium text-blue-700 mb-2">
                    Event Title
                  </label>
                  <input
                    id="eventTitle"
                ...
                <div>
                  <label htmlFor="eventDesc" className="block text-sm font-medium text-blue-700 mb-2">
                    Event Description
                  </label>
                  <textarea
                    id="eventDesc"
            ...
            <div className="space-y-6">
              ...
              {announcements.length === 0 ? (
                <div className="text-center py-8 bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl border border-emerald-200">
                  ...
                  <p className="text-emerald-500 text-sm mt-1">Create your first announcement below</p>
                </div>
              ) : (
                    ...
                    >
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          ...
                          <p className="text-emerald-700 mb-2">{announcement.content}</p>
              ...
              <form onSubmit={handleAnnouncementSubmit} className="space-y-4 bg-gradient-to-br from-emerald-50 to-white p-6 rounded-xl border border-emerald-200">
                <h4 className="font-semibold text-emerald-800 text-lg mb-4">➕ Add New Announcement</h4>
                <div>
                  <label htmlFor="announceTitle" className="block text-sm font-medium text-emerald-700 mb-2">
                    Announcement Title
                  </label>
                  <input
                    id="announceTitle"
                ...
                <div>
                  <label htmlFor="announceContent" className="block text-sm font-medium text-emerald-700 mb-2">
