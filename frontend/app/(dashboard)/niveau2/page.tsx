      ...
      <ResizablePanelGroup direction="horizontal">
        <ResizablePanel defaultSize={20} minSize={15} maxSize={25}>
          <Sidebar
            ...
            className="border-r h-screen bg-card"
          />
        </ResizablePanel>
            ...
            <div className="flex-1 space-y-6 p-8 pt-6">
              <div className="flex items-center justify-between border-b pb-4">
                <div className="space-y-1">
                  <h2 className="text-3xl font-bold tracking-tight">Rapport 8D</h2>
              ...
              <Card className="border-2">
                <CardHeader className="pb-3">
                  ...
                  <CardDescription>Vue d'ensemble de l'avancement par section</CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    {sections.map((section) => (
                      <div
                        ...
                        className={`p-4 border rounded-lg transition-colors cursor-pointer
                          ${currentSection === section.id ? 'bg-accent border-primary' : 'hover:bg-accent/50'}`}
                      ...
                      >
                        <div className="flex items-center justify-between text-sm mb-2">
                          ...
                          <span className="text-muted-foreground">{progress[section.id]}%</span>
                        </div>
                        <Progress value={progress[section.id]} className="h-2" />
                      </div>
                    ))}
                  </div>
                </CardContent>
